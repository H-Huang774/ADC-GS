...
from downsample_point import process_ply_file
...
if __name__ == "__main__" :
    ...
    inputpath = videopath + "/colmap/dense/workspace/fused.ply"
    outputpath = videopath + "points3D_downsample.ply"
    process_ply_file(inputpath, outputpath)
